...
public class PaymentBOImpl implements PaymentBO {
    ...
    public CarDto searchCar(String carNo) throws SQLException {
        ...
        CarDto carDto = new CarDto(car.getCarNo(),car.getBrand(),car.getAvailability(),car.getCurrentMileage(), car.getKmOneDay(), car.getPriceOneDay(),car.getPriceExtraKm());
        return carDto;
    }
    ...
    public DriverDto searchDriver(String id) throws SQLException {
        ...
        DriverDto driverDto = new DriverDto(driver.getId(),driver.getName(),driver.getAddress(),driver.getEmail(),driver.getContact(),driver.getLicenseNo(),driver.getUserName(),driver.getAvailability());
        return driverDto;
    }
    ...
    public List<BookingDetailDTO> getAllBookings() throws SQLException {
        ...
        for (BookingDetail bookingDetail : bookingDetails){
            dtoList.add(new BookingDetailDTO(bookingDetail.getBId(), bookingDetail.getCarNo(), bookingDetail.getDriverId()));
        }
        return dtoList;
    }
    ...
    public boolean savePayment(String bId, double totalPayment, String pickUpDate, BookingDetailDTO bookingDetailDTO) throws SQLException {
        BookingDetail bookingDetail = new BookingDetail(bookingDetailDTO.getBId(),bookingDetailDTO.getCarNo(),bookingDetailDTO.getDriverId());
    ...
    public List<PaymentDetailDTO> searchPaymentDetail(String bId) throws SQLException {
        ...
        for (PaymentDetail paymentDetail : paymentDetails){
            dtoList.add(new PaymentDetailDTO(paymentDetail.getBId(), paymentDetail.getPickUpDate(), paymentDetail.getDays(), paymentDetail.getStatus(),paymentDetail.getPayment(), paymentDetail.getCusId(), paymentDetail.getCarNo(),paymentDetail.getDrId()));
        }
        return dtoList;
    }
    ...
    public boolean saveOneCarPay(OneCarPayDTO dto) throws SQLException {
        return oneCarPayDAO.save(new OneCarPay(dto.getBId(), dto.getCarNo(),dto.getExtraKm(),dto.getDriverCost(),dto.getSubTotal()));
    }
}
